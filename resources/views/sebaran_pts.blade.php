...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Daftar Perguruan Tinggi di Wilayah LLDIKTI 4</h6>
            </div>
        <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0"> <!-- Added table-bordered for clearer separation of cells -->
                        ...
                        <tr>
                            <td>{{ $item['npsn'] }}</td>
                            <td>
                            <a href="https://direktori.lldikti4.id/perguruantinggi/viewdir/{{ $item['npsn'] }}" target="_blank">
                                {{ $item['nm_lemb'] }}
                            </a>
                            </td>
                            <td>{{ $item['kota_kab'] }}</td>
