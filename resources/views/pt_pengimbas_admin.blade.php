...
<body>
    ...
    <div class="card-body">
        <a href="/admin/penugasaan_pengimbas/create" class="btn btn-primary btn-user">+ Tambah Penugasan</a>
        <a href="/admin/pt_pengimbas/create" class="btn btn-primary btn-user">+ Tambah PT Pengimbas</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Form untuk delete -->
                        <form action="{{ route('delete_pt_pengimbas', $item['kode_pt_peng'] ) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Anda yakin akan menghapus penugasan?');">
                            @csrf
                            @method('DELETE')
                                            ...
                                            <tbody>
                                                @foreach ($item['pt_asuh'] as $pt_asuh)
                                                    <tr>
                                                        ...
                                                        <td>                                                                                            
                                                            <!-- Form untuk delete -->
                                                            <form action="{{ route('delete_pt_asuh', $pt_asuh['kode_pt_asuh']) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Anda yakin akan menghapus penugasan?');">
                                                                @csrf
                                                                @method('DELETE')
