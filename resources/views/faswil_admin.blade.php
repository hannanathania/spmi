    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="/admin/penugasan_faswil/create" class="btn btn-primary btn-user">+ Tambah Penugasan Verifikator</a>
                <a href="/admin/fasilitator_wilayah/create" class="btn btn-primary btn-user">+ Tambah Verifikator</a>
                        ...
                        <tbody>
                            @foreach ($groupedData as $kode_faswil => $items)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#detailModal{{ $kode_faswil }}">
                                        ...
                                        <a href="{{ route('faswil.edit', $items['kode_faswil']) }}" class="btn btn-secondary btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('faswil.delete', $items['kode_faswil'])}}" method="POST" style="display:inline-block;" onsubmit="return confirm('Anda yakin akan menghapus verifikator?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger">
                                                <i class="fas fa-trash"></i>
