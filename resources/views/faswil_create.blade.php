...
<body>
    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Penugasan Fasilitator Wilayah</h6>
            </div>
            <div class="card-body">
                <form>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Perguruan Tinggi</label>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Fasilitator Wilayah</label>
                        <select class="form-control" id="exampleFormControlSelect1">
                        <option>-</option>
                ...
                <a href="" class="btn btn-primary mt-0">Submit</a>
            </div>
        </div>
    </div>
